...
// of the container
if (Options.scrollVertical == false) { var horizontal = true; }
...
if (Options.showArrows == true) {
	$scroll
	  .after('<img src="'+ Options.arrowLeft + '" class="scrollButtons left" id="scrollLeft"/><img src="'+ Options.arrowRight + '" class="scrollButtons right" id="scrollRight"/>');
};
...
var scrollOptions = {
  ...
  force: (Options.autoSlider == true) ? 1 : 0,
  interval: (Options.autoSlider == true) ? Options.autoSliderFrequency : '',    
